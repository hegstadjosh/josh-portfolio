...
Checked 2026-08-25. The website and GitHub changes are public. LinkedIn remains unchanged.

## GitHub

- Display name: `Joshua Hegstad`
- Bio: `Co-Founder. Computer science at Columbia.`
...
Josh will write the LinkedIn copy. Do not publish the discarded draft or reuse its CTO, retrieval, grounding, or live-voice claims.

## Repository archive candidates

None of these commands has run. Review each repository before archiving it.
...
GitHub was verified through the public profile and API after the update.
